...
$slidShowQuery = new WP_Query($args);

?>
<?php if ($slidShowQuery->have_posts()) : ?>
<div class="hero-slider">
  <div data-glide-el="track" class="glide__track">
    <div class="glide__slides">
      <?php while ($slidShowQuery->have_posts()) : $slidShowQuery->the_post(); ?>
      <div class="hero-slider__slide"
        style="background-image: url(<?php echo get_field('slideshow_background_image')['url']; ?>);">
        <div class="hero-slider__interior container">
          <div class="hero-slider__overlay">
            <h2 class="headline headline--medium t-center"><?php the_title(); ?></h2>
            <p class="t-center"><?php the_field('slideshow_subtitle'); ?></p>
            <p class="t-center no-margin"><a href="<?php echo get_field('slideshow_button_url'); ?>"
                class="btn btn--blue"><?php the_field('slideshow_button_text'); ?></a></p>
          </div>
        </div>
      </div>
      <?php endwhile; ?>
